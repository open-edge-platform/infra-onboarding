...
func GetCommonInfraTemplateVariables(
	...
	templateVariables := map[string]interface{}{
		...
		"ORCH_PLATFORM_OBS_METRICS_CLI_HOST": strings.Split(infraConfig.MetricsCLIObservabilityURL, ":")[0],
		"ORCH_PLATFORM_OBS_METRICS_CLI_PORT": strings.Split(infraConfig.MetricsCLIObservabilityURL, ":")[1],
