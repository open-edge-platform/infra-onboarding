...
// func TestOnboardingController_controlLoop(t *testing.T) {
// 	type fields struct {
// 		invClient   *invclient.OnboardingInventoryClient
// 		filters     map[inv_v1.ResourceKind]Filter
// 		controllers map[inv_v1.ResourceKind]*rec_v2.Controller[reconcilers.ResourceID]
...
// 	invClient.On("FindAll", mock.Anything, mock.Anything, mock.Anything).
// 		Return([]string{}, nil)
// 	mockFilters := make(map[inv_v1.ResourceKind]Filter)
// 	mockControllers := make(map[inv_v1.ResourceKind]*rec_v2.Controller[reconcilers.ResourceID])
// 	wg := &sync.WaitGroup{}
// 	stop := make(chan bool)
// 	watchEvent := &inv_client.WatchEvents{
// 		Event: &inv_v1.SubscribeEventsResponse{
// 			ClientUuid: "9fa8a788-f9f8-434a-8620-bbed2a12b0ad",
// 		},
// 	}
// 	tests := []struct {
// 		name   string
...
// 			//     },
// 			// }
// 			tt.fields.invClient.Watcher <- watchEvent
...
// func TestOnboardingController_reconcileResource(t *testing.T) {
// 	type fields struct {
// 		invClient   *invclient.OnboardingInventoryClient
// 		filters     map[inv_v1.ResourceKind]Filter
// 		controllers map[inv_v1.ResourceKind]*rec_v2.Controller[reconcilers.ResourceID]
...
// 	// Reconciler := 
// 	// controllers:= map[inv_v1.ResourceKind]*rec_v2.Controller[reconcilers.ResourceID]{
// 	// 	inv_v1.ResourceKind_RESOURCE_KIND_INSTANCE: &rec_v2.Controller[reconcilers.ResourceID]{
// 	// 		// reconciler: Reconciler[I]{}, // Initialize the reconciler separately if possible
// 	// 		partitions: make([]chan Request[I], 1), // Initialize partitions with a non-zero length
// 	// 		Log:        nil, // Set the Logger field as needed
// 	// 		timeout:    time.Second, // Set the timeout duration as needed
// 	// 	},
// 	// }
// 	type args struct {
// 		resourceID string
...
// 			fields: fields{
// 				invClient: &invclient.OnboardingInventoryClient{},
// 				filters: map[inv_v1.ResourceKind]Filter{inv_v1.ResourceKind_RESOURCE_KIND_INSTANCE: func(event *inv_v1.SubscribeEventsResponse) bool {
// 					return false
// 				}},
// 				controllers: map[inv_v1.ResourceKind]*rec_v2.Controller[reconcilers.ResourceID]{
...
// 				t.Errorf("OnboardingController.reconcileResource() error = %v, wantErr %v", err, tt.wantErr)
// 			}
// 		})
// 	}
// }
