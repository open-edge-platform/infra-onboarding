...
type SecureBootStatRequest_Status int32

const (
	SecureBootStatRequest_SUCCESS SecureBootStatRequest_Status = 0 // Success
	SecureBootStatRequest_FAILURE SecureBootStatRequest_Status = 1 // Failure
)

// Enum value maps for SecureBootStatRequest_Status.
var (
	SecureBootStatRequest_Status_name = map[int32]string{
		0: "SUCCESS",
		1: "FAILURE",
	}
	SecureBootStatRequest_Status_value = map[string]int32{
		"SUCCESS": 0,
		"FAILURE": 1,
	}
)

func (x SecureBootStatRequest_Status) Enum() *SecureBootStatRequest_Status {
	p := new(SecureBootStatRequest_Status)
	*p = x
	return p
}

func (x SecureBootStatRequest_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecureBootStatRequest_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_onboarding_proto_enumTypes[3].Descriptor()
}

func (SecureBootStatRequest_Status) Type() protoreflect.EnumType {
	return &file_onboarding_proto_enumTypes[3]
}

func (x SecureBootStatRequest_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SecureBootStatRequest_Status.Descriptor instead.
func (SecureBootStatRequest_Status) EnumDescriptor() ([]byte, []int) {
	return file_onboarding_proto_rawDescGZIP(), []int{14, 0}
}

type SecureBootResponse_Status int32

const (
	SecureBootResponse_SUCCESS SecureBootResponse_Status = 0 // Success
	SecureBootResponse_FAILURE SecureBootResponse_Status = 1 // Failure
)

// Enum value maps for SecureBootResponse_Status.
var (
	SecureBootResponse_Status_name = map[int32]string{
		0: "SUCCESS",
		1: "FAILURE",
	}
	SecureBootResponse_Status_value = map[string]int32{
		"SUCCESS": 0,
		"FAILURE": 1,
	}
)

func (x SecureBootResponse_Status) Enum() *SecureBootResponse_Status {
	p := new(SecureBootResponse_Status)
	*p = x
	return p
}

func (x SecureBootResponse_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecureBootResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_onboarding_proto_enumTypes[4].Descriptor()
}

func (SecureBootResponse_Status) Type() protoreflect.EnumType {
	return &file_onboarding_proto_enumTypes[4]
}

func (x SecureBootResponse_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SecureBootResponse_Status.Descriptor instead.
func (SecureBootResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_onboarding_proto_rawDescGZIP(), []int{15, 0}
}
...
type SecureBootStatRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Result SecureBootStatRequest_Status `protobuf:"varint,1,opt,name=result,proto3,enum=onboardingmgr.SecureBootStatRequest_Status" json:"result,omitempty"`
	Guid   string                       `protobuf:"bytes,2,opt,name=guid,proto3" json:"guid,omitempty"` // GUID
}

func (x *SecureBootStatRequest) Reset() {
	*x = SecureBootStatRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SecureBootStatRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecureBootStatRequest) ProtoMessage() {}

func (x *SecureBootStatRequest) ProtoReflect() protoreflect.Message {
	mi := &file_onboarding_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecureBootStatRequest.ProtoReflect.Descriptor instead.
func (*SecureBootStatRequest) Descriptor() ([]byte, []int) {
	return file_onboarding_proto_rawDescGZIP(), []int{14}
}

func (x *SecureBootStatRequest) GetResult() SecureBootStatRequest_Status {
	if x != nil {
		return x.Result
	}
	return SecureBootStatRequest_SUCCESS
}

func (x *SecureBootStatRequest) GetGuid() string {
	if x != nil {
		return x.Guid
	}
	return ""
...
type SecureBootResponse struct {
	...
	Result SecureBootResponse_Status `protobuf:"varint,1,opt,name=result,proto3,enum=onboardingmgr.SecureBootResponse_Status" json:"result,omitempty"`
	Guid   string                    `protobuf:"bytes,2,opt,name=guid,proto3" json:"guid,omitempty"`
}

func (x *SecureBootResponse) Reset() {
	*x = SecureBootResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SecureBootResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecureBootResponse) ProtoMessage() {}

func (x *SecureBootResponse) ProtoReflect() protoreflect.Message {
	mi := &file_onboarding_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecureBootResponse.ProtoReflect.Descriptor instead.
func (*SecureBootResponse) Descriptor() ([]byte, []int) {
	return file_onboarding_proto_rawDescGZIP(), []int{15}
}

func (x *SecureBootResponse) GetResult() SecureBootResponse_Status {
	if x != nil {
		return x.Result
	}
	return SecureBootResponse_SUCCESS
}

func (x *SecureBootResponse) GetGuid() string {
	if x != nil {
		return x.Guid
	}
	return ""
...
var file_onboarding_proto_rawDesc = []byte{
	...
	0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x01, 0x22, 0x98, 0x03, 0x0a, 0x06, 0x48, 0x77, 0x44, 0x61,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x73,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x0b, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x1a, 0x2e, 0x6f, 0x6e, 0x62,
	...
	0x69, 0x6e, 0x67, 0x6d, 0x67, 0x72, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x0b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4e,
	...
	,
...
var file_onboarding_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_onboarding_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_onboarding_proto_goTypes = []interface{}{
	...
	(SecureBootStatRequest_Status)(0),  // 3: onboardingmgr.SecureBootStatRequest.Status
	(SecureBootResponse_Status)(0),     // 4: onboardingmgr.SecureBootResponse.Status
	(*ArtifactRequest)(nil),            // 5: onboardingmgr.ArtifactRequest
	(*ArtifactResponse)(nil),           // 6: onboardingmgr.ArtifactResponse
	...
	(*OnboardingParams)(nil),           // 15: onboardingmgr.OnboardingParams
	(*CustomerParams)(nil),             // 16: onboardingmgr.CustomerParams
	(*OnboardingRequest)(nil),          // 17: onboardingmgr.OnboardingRequest
	(*OnboardingResponse)(nil),         // 18: onboardingmgr.OnboardingResponse
	(*SecureBootStatRequest)(nil),      // 19: onboardingmgr.SecureBootStatRequest
	(*SecureBootResponse)(nil),         // 20: onboardingmgr.SecureBootResponse
}
var file_onboarding_proto_depIdxs = []int32{
	...
	16, // 9: onboardingmgr.HwData.cus_params:type_name -> onboardingmgr.CustomerParams
	13, // 10: onboardingmgr.OnboardingParams.proxy:type_name -> onboardingmgr.Proxy
	14, // 11: onboardingmgr.OnboardingParams.port:type_name -> onboardingmgr.Ports
	7,  // 12: onboardingmgr.OnboardingRequest.artifactData:type_name -> onboardingmgr.ArtifactData
	12, // 13: onboardingmgr.OnboardingRequest.hwdata:type_name -> onboardingmgr.HwData
	16, // 14: onboardingmgr.OnboardingRequest.cusParams:type_name -> onboardingmgr.CustomerParams
	15, // 15: onboardingmgr.OnboardingRequest.OnbParams:type_name -> onboardingmgr.OnboardingParams
	3,  // 16: onboardingmgr.SecureBootStatRequest.result:type_name -> onboardingmgr.SecureBootStatRequest.Status
	4,  // 17: onboardingmgr.SecureBootResponse.result:type_name -> onboardingmgr.SecureBootResponse.Status
	5,  // 18: onboardingmgr.NodeArtifactServiceNB.CreateArtifacts:input_type -> onboardingmgr.ArtifactRequest
	5,  // 19: onboardingmgr.NodeArtifactServiceNB.GetArtifacts:input_type -> onboardingmgr.ArtifactRequest
	5,  // 20: onboardingmgr.NodeArtifactServiceNB.UpdateArtifactsById:input_type -> onboardingmgr.ArtifactRequest
	5,  // 21: onboardingmgr.NodeArtifactServiceNB.DeleteArtifacts:input_type -> onboardingmgr.ArtifactRequest
	9,  // 22: onboardingmgr.NodeArtifactServiceNB.CreateNodes:input_type -> onboardingmgr.NodeRequest
	9,  // 23: onboardingmgr.NodeArtifactServiceNB.GetNodes:input_type -> onboardingmgr.NodeRequest
	9,  // 24: onboardingmgr.NodeArtifactServiceNB.UpdateNodes:input_type -> onboardingmgr.NodeRequest
	9,  // 25: onboardingmgr.NodeArtifactServiceNB.DeleteNodes:input_type -> onboardingmgr.NodeRequest
	17, // 26: onboardingmgr.OnBoardingEB.StartOnboarding:input_type -> onboardingmgr.OnboardingRequest
	19, // 27: onboardingmgr.OnBoardingSB.SecureBootStatus:input_type -> onboardingmgr.SecureBootStatRequest
	6,  // 28: onboardingmgr.NodeArtifactServiceNB.CreateArtifacts:output_type -> onboardingmgr.ArtifactResponse
	6,  // 29: onboardingmgr.NodeArtifactServiceNB.GetArtifacts:output_type -> onboardingmgr.ArtifactResponse
	6,  // 30: onboardingmgr.NodeArtifactServiceNB.UpdateArtifactsById:output_type -> onboardingmgr.ArtifactResponse
	6,  // 31: onboardingmgr.NodeArtifactServiceNB.DeleteArtifacts:output_type -> onboardingmgr.ArtifactResponse
	10, // 32: onboardingmgr.NodeArtifactServiceNB.CreateNodes:output_type -> onboardingmgr.NodeResponse
	10, // 33: onboardingmgr.NodeArtifactServiceNB.GetNodes:output_type -> onboardingmgr.NodeResponse
	10, // 34: onboardingmgr.NodeArtifactServiceNB.UpdateNodes:output_type -> onboardingmgr.NodeResponse
	10, // 35: onboardingmgr.NodeArtifactServiceNB.DeleteNodes:output_type -> onboardingmgr.NodeResponse
	18, // 36: onboardingmgr.OnBoardingEB.StartOnboarding:output_type -> onboardingmgr.OnboardingResponse
	20, // 37: onboardingmgr.OnBoardingSB.SecureBootStatus:output_type -> onboardingmgr.SecureBootResponse
...
func file_onboarding_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_onboarding_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SecureBootStatRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_onboarding_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SecureBootResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
