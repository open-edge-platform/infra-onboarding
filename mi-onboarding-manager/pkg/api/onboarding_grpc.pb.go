...
func (c *onBoardingEBClient) StartOnboarding(ctx context.Context, in *OnboardingRequest, opts ...grpc.CallOption) (*OnboardingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/onboardingmgr.OnBoardingEB/StartOnboarding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedOnBoardingEBServer
// for forward compatibility
...
// UnimplementedOnBoardingEBServer should be embedded to have forward compatible implementations.
...
func _OnBoardingEB_StartOnboarding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/onboardingmgr.OnBoardingEB/StartOnboarding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
