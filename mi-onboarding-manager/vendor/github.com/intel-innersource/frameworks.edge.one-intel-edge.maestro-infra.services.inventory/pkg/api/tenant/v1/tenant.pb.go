...
func (x *ProjectResource) GetResourceId() string {
	if x != nil {
		return x.ResourceId
	}
	return ""
...
func (x *ProjectResource) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
type UserResource struct {
	...
	SshPubkey  string `protobuf:"bytes,17,opt,name=ssh_pubkey,json=sshPubkey,proto3" json:"ssh_pubkey,omitempty"`
}
...
func (x *UserResource) GetResourceId() string {
	if x != nil {
		return x.ResourceId
	}
	return ""
...
func (x *UserResource) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *UserResource) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UserResource) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UserResource) GetSshPubkey() string {
	if x != nil {
		return x.SshPubkey
	}
	return ""
...
var file_tenant_v1_tenant_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x1a, 0x0e, 0x65, 0x6e, 0x74, 0x2f, 0x6f, 0x70, 0x74, 0x73, 0x2e, 0x70, 0x72,
	...
	0x5e, 0x70, 0x72, 0x6f, 0x6a, 0x2d, 0x5b, 0x30, 0x2d, 0x39, 0x61, 0x2d, 0x66, 0x5d, 0x7b, 0x38,
	...
	0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x3a,
	0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xfb, 0x01, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72,
	...
	0x42, 0x1b, 0x72, 0x19, 0x28, 0x0d, 0x32, 0x12, 0x5e, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x5b, 0x30,
	...
	,
	...
	0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x65,
...
var file_tenant_v1_tenant_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_tenant_v1_tenant_proto_goTypes = []interface{}{
	(*ProjectResource)(nil), // 0: tenant.v1.ProjectResource
	(*UserResource)(nil),    // 1: tenant.v1.UserResource
}
