...
type HostResource struct {
	...
	ConsumerId           string                `protobuf:"bytes,14,opt,name=consumer_id,json=consumerId,proto3" json:"consumer_id,omitempty"`                                 // ID of the metal/VM provider
	...
	GpuPciId          string                  `protobuf:"bytes,27,opt,name=gpu_pci_id,json=gpuPciId,proto3" json:"gpu_pci_id,omitempty"`                                                        // PCI device id of GPU
	GpuProduct        string                  `protobuf:"bytes,28,opt,name=gpu_product,json=gpuProduct,proto3" json:"gpu_product,omitempty"`                                                    // Product info of GPU
	GpuVendor         string                  `protobuf:"bytes,29,opt,name=gpu_vendor,json=gpuVendor,proto3" json:"gpu_vendor,omitempty"`                                                       // Vendor info of GPU
...
func (x *HostResource) GetDescription() string {
	if x != nil {
...
func (x *HostResource) GetConsumerId() string {
	if x != nil {
		return x.ConsumerId
	}
	return ""
...
func (x *HostResource) GetGpuPciId() string {
	if x != nil {
		return x.GpuPciId
	}
	return ""
...
func (x *HostResource) GetGpuProduct() string {
	if x != nil {
		return x.GpuProduct
	}
	return ""
...
func (x *HostResource) GetGpuVendor() string {
	if x != nil {
		return x.GpuVendor
	}
	return ""
...
type HoststorageResource struct {
	...
	Kind           string                `protobuf:"bytes,2,opt,name=kind,proto3" json:"kind,omitempty"`                               // Kind of resource. Frequently tied to Provider
	Description    string                `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`                 // human readable description
	DesiredState   HostComponentState    `protobuf:"varint,4,opt,name=desired_state,json=desiredState,proto3,enum=compute.v1.HostComponentState" json:"desired_state,omitempty"`
	CurrentState   HostComponentState    `protobuf:"varint,5,opt,name=current_state,json=currentState,proto3,enum=compute.v1.HostComponentState" json:"current_state,omitempty"`
	...
	Name          string `protobuf:"bytes,21,opt,name=name,proto3" json:"name,omitempty"`                                         // Device name (OS provided, like sda, sdb, etc.)
}
...
func (x *HoststorageResource) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *HoststorageResource) GetDesiredState() HostComponentState {
	if x != nil {
		return x.DesiredState
	}
	return HostComponentState_HOST_COMPONENT_STATE_UNSPECIFIED
}

func (x *HoststorageResource) GetCurrentState() HostComponentState {
	if x != nil {
		return x.CurrentState
	}
	return HostComponentState_HOST_COMPONENT_STATE_UNSPECIFIED
...
func (x *HoststorageResource) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type HostnicResource struct {
	...
	Name                string                    `protobuf:"bytes,16,opt,name=name,proto3" json:"name,omitempty"`                                                                       // the device name (OS provided, like eth0, enp1s0, etc.)
...
func (x *HostnicResource) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *HostnicResource) GetDesiredState() HostComponentState {
	if x != nil {
		return x.DesiredState
	}
	return HostComponentState_HOST_COMPONENT_STATE_UNSPECIFIED
...
func (x *HostnicResource) GetCurrentState() HostComponentState {
	if x != nil {
		return x.CurrentState
	}
	return HostComponentState_HOST_COMPONENT_STATE_UNSPECIFIED
...
func (x *HostnicResource) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type HostusbResource struct {
	...
	Description  string             `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`                 // human readable description
	CurrentState HostComponentState `protobuf:"varint,4,opt,name=current_state,json=currentState,proto3,enum=compute.v1.HostComponentState" json:"current_state,omitempty"`
	DesiredState HostComponentState `protobuf:"varint,5,opt,name=desired_state,json=desiredState,proto3,enum=compute.v1.HostComponentState" json:"desired_state,omitempty"`
...
func (x *HostusbResource) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *HostusbResource) GetCurrentState() HostComponentState {
	if x != nil {
		return x.CurrentState
	}
	return HostComponentState_HOST_COMPONENT_STATE_UNSPECIFIED
...
func (x *HostusbResource) GetDesiredState() HostComponentState {
	if x != nil {
		return x.DesiredState
	}
	return HostComponentState_HOST_COMPONENT_STATE_UNSPECIFIED
...
type InstanceResource struct {
	...
	Description     string                       `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`                 // Human readable name.
...
func (x *InstanceResource) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *WorkloadResource) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_compute_v1_compute_proto_rawDesc = []byte{
	...
	0x80, 0x12, 0x0a, 0x0c, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	,
	...
	,
	...
	0x72, 0x12, 0x3c, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x50,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x06,
	0xc2, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12,
	0x33, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	...
	,
	...
	0x63, 0x65, 0x42, 0x0c, 0xc2, 0xa6, 0x49, 0x08, 0x08, 0x01, 0x12, 0x04, 0x68, 0x6f, 0x73, 0x74,
	0x52, 0x08, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x3a, 0x06, 0xba, 0xa6, 0x49, 0x02,
	0x08, 0x01, 0x22, 0xb1, 0x06, 0x0a, 0x13, 0x48, 0x6f, 0x73, 0x74, 0x73, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x4c, 0x0a, 0x0b, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x2b, 0xfa, 0x42, 0x22, 0x72, 0x20, 0x28, 0x14, 0x32, 0x19, 0x5e, 0x68, 0x6f, 0x73, 0x74, 0x73,
	0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2d, 0x5b, 0x30, 0x2d, 0x39, 0x61, 0x2d, 0x66, 0x5d, 0x7b,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x2f, 0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x0e, 0x70, 0x72, 0x6f, 0x76, 0x69,
	0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x35, 0x0a, 0x04, 0x73, 0x69, 0x74,
	...
	0x74, 0x12, 0x36, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x65, 0x73, 0x12, 0x1a, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x3a, 0x06,
	0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xb5, 0x0b, 0x0a, 0x0f, 0x48, 0x6f, 0x73, 0x74, 0x6e,
	0x69, 0x63, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x0b, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x27, 0xfa, 0x42, 0x1e, 0x72, 0x1c, 0x28, 0x10, 0x32, 0x15, 0x5e, 0x68, 0x6f, 0x73, 0x74, 0x6e,
	0x69, 0x63, 0x2d, 0x5b, 0x30, 0x2d, 0x39, 0x61, 0x2d, 0x66, 0x5d, 0x7b, 0x38, 0x7d, 0x24, 0xd0,
	...
	,
	...
	,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x24, 0xfa, 0x42, 0x1b, 0x72, 0x19, 0x28, 0x0d,
	0x32, 0x12, 0x5e, 0x69, 0x6e, 0x73, 0x74, 0x2d, 0x5b, 0x30, 0x2d, 0x39, 0x61, 0x2d, 0x66, 0x5d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x4f, 0x57, 0x4e, 0x10, 0x02, 0x2a, 0xbb, 0x01, 0x0a, 0x0d, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	...
	,
	...
	,
	...
	,
}
...
var file_compute_v1_compute_proto_goTypes = []interface{}{
	...
	(*InstanceResource)(nil),            // 16: compute.v1.InstanceResource
	(*WorkloadResource)(nil),            // 17: compute.v1.WorkloadResource
	(*WorkloadMember)(nil),              // 18: compute.v1.WorkloadMember
	(*v1.SiteResource)(nil),             // 19: location.v1.SiteResource
	(*v11.ProviderResource)(nil),        // 20: provider.v1.ProviderResource
	(*v12.ProjectResource)(nil),         // 21: tenant.v1.ProjectResource
	(*v12.UserResource)(nil),            // 22: tenant.v1.UserResource
	(*v13.OperatingSystemResource)(nil), // 23: os.v1.OperatingSystemResource
}
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	19, // 3: compute.v1.HostResource.site:type_name -> location.v1.SiteResource
	20, // 4: compute.v1.HostResource.provider:type_name -> provider.v1.ProviderResource
	21, // 5: compute.v1.HostResource.project:type_name -> tenant.v1.ProjectResource
	22, // 6: compute.v1.HostResource.user:type_name -> tenant.v1.UserResource
	...
	16, // 13: compute.v1.HostResource.instance:type_name -> compute.v1.InstanceResource
	4,  // 14: compute.v1.HoststorageResource.desired_state:type_name -> compute.v1.HostComponentState
	4,  // 15: compute.v1.HoststorageResource.current_state:type_name -> compute.v1.HostComponentState
	19, // 16: compute.v1.HoststorageResource.site:type_name -> location.v1.SiteResource
	20, // 17: compute.v1.HoststorageResource.provider:type_name -> provider.v1.ProviderResource
	21, // 18: compute.v1.HoststorageResource.project:type_name -> tenant.v1.ProjectResource
	12, // 19: compute.v1.HoststorageResource.host:type_name -> compute.v1.HostResource
	4,  // 20: compute.v1.HostnicResource.desired_state:type_name -> compute.v1.HostComponentState
	4,  // 21: compute.v1.HostnicResource.current_state:type_name -> compute.v1.HostComponentState
	19, // 22: compute.v1.HostnicResource.site:type_name -> location.v1.SiteResource
	20, // 23: compute.v1.HostnicResource.provider:type_name -> provider.v1.ProviderResource
	21, // 24: compute.v1.HostnicResource.project:type_name -> tenant.v1.ProjectResource
	12, // 25: compute.v1.HostnicResource.host:type_name -> compute.v1.HostResource
	5,  // 26: compute.v1.HostnicResource.link_state:type_name -> compute.v1.NetworkInterfaceLinkState
	4,  // 27: compute.v1.HostusbResource.current_state:type_name -> compute.v1.HostComponentState
	4,  // 28: compute.v1.HostusbResource.desired_state:type_name -> compute.v1.HostComponentState
	12, // 29: compute.v1.HostusbResource.host:type_name -> compute.v1.HostResource
	7,  // 30: compute.v1.InstanceResource.kind:type_name -> compute.v1.InstanceKind
	6,  // 31: compute.v1.InstanceResource.desired_state:type_name -> compute.v1.InstanceState
	6,  // 32: compute.v1.InstanceResource.current_state:type_name -> compute.v1.InstanceState
	12, // 33: compute.v1.InstanceResource.host:type_name -> compute.v1.HostResource
	22, // 34: compute.v1.InstanceResource.user:type_name -> tenant.v1.UserResource
	23, // 35: compute.v1.InstanceResource.os:type_name -> os.v1.OperatingSystemResource
	8,  // 36: compute.v1.InstanceResource.status:type_name -> compute.v1.InstanceStatus
	18, // 37: compute.v1.InstanceResource.workload_members:type_name -> compute.v1.WorkloadMember
	10, // 38: compute.v1.WorkloadResource.kind:type_name -> compute.v1.WorkloadKind
	9,  // 39: compute.v1.WorkloadResource.desired_state:type_name -> compute.v1.WorkloadState
	9,  // 40: compute.v1.WorkloadResource.current_state:type_name -> compute.v1.WorkloadState
	18, // 41: compute.v1.WorkloadResource.members:type_name -> compute.v1.WorkloadMember
	11, // 42: compute.v1.WorkloadMember.kind:type_name -> compute.v1.WorkloadMemberKind
	17, // 43: compute.v1.WorkloadMember.workload:type_name -> compute.v1.WorkloadResource
	16, // 44: compute.v1.WorkloadMember.instance:type_name -> compute.v1.InstanceResource
