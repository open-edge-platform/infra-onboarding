...
func (hrc *HostResourceCreate) SetProviderStatus(s string) *HostResourceCreate {
	hrc.mutation.SetProviderStatus(s)
	return hrc
}

// SetNillableProviderStatus sets the "provider_status" field if the given value is not nil.
func (hrc *HostResourceCreate) SetNillableProviderStatus(s *string) *HostResourceCreate {
	if s != nil {
...
func (hrc *HostResourceCreate) SetHostStatus(hs hostresource.HostStatus) *HostResourceCreate {
	hrc.mutation.SetHostStatus(hs)
	return hrc
}

// SetNillableHostStatus sets the "host_status" field if the given value is not nil.
func (hrc *HostResourceCreate) SetNillableHostStatus(hs *hostresource.HostStatus) *HostResourceCreate {
	if hs != nil {
		hrc.SetHostStatus(*hs)
	}
	return hrc
}

// SetProviderStatusDetail sets the "provider_status_detail" field.
func (hrc *HostResourceCreate) SetProviderStatusDetail(s string) *HostResourceCreate {
	hrc.mutation.SetProviderStatusDetail(s)
	return hrc
}

// SetNillableProviderStatusDetail sets the "provider_status_detail" field if the given value is not nil.
func (hrc *HostResourceCreate) SetNillableProviderStatusDetail(s *string) *HostResourceCreate {
	if s != nil {
		hrc.SetProviderStatusDetail(*s)
	}
	return hrc
}
...
func (hrc *HostResourceCreate) SetProjectID(id int) *HostResourceCreate {
...
func (hrc *HostResourceCreate) SetNillableProjectID(id *int) *HostResourceCreate {
	if id != nil {
...
func (hrc *HostResourceCreate) SetProject(p *ProjectResource) *HostResourceCreate {
	return hrc.SetProjectID(p.ID)
}

// SetUserID sets the "user" edge to the UserResource entity by ID.
func (hrc *HostResourceCreate) SetUserID(id int) *HostResourceCreate {
	hrc.mutation.SetUserID(id)
	return hrc
}

// SetNillableUserID sets the "user" edge to the UserResource entity by ID if the given value is not nil.
func (hrc *HostResourceCreate) SetNillableUserID(id *int) *HostResourceCreate {
	if id != nil {
		hrc = hrc.SetUserID(*id)
	}
	return hrc
}

// SetUser sets the "user" edge to the UserResource entity.
func (hrc *HostResourceCreate) SetUser(u *UserResource) *HostResourceCreate {
	return hrc.SetUserID(u.ID)
}
...
func (hrc *HostResourceCreate) Save(ctx context.Context) (*HostResource, error) {
	return withHooks[*HostResource, HostResourceMutation](ctx, hrc.sqlSave, hrc.mutation, hrc.hooks)
}
...
func (hrc *HostResourceCreate) check() error {
	...
	if v, ok := hrc.mutation.HostStatus(); ok {
...
func (hrc *HostResourceCreate) createSpec() (*HostResource, *sqlgraph.CreateSpec) {
	...
	if value, ok := hrc.mutation.ProviderStatusDetail(); ok {
		_spec.SetField(hostresource.FieldProviderStatusDetail, field.TypeString, value)
		_node.ProviderStatusDetail = value
	}
	...
	if nodes := hrc.mutation.ProjectIDs(); len(nodes) > 0 {
		...
		_node.host_resource_project = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := hrc.mutation.UserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.host_resource_user = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
