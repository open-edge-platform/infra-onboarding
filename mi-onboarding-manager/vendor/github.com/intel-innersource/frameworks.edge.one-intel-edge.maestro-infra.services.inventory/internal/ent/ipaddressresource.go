...
func (*IPAddressResource) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case ipaddressresource.FieldResourceID, ipaddressresource.FieldAddress, ipaddressresource.FieldDesiredState, ipaddressresource.FieldCurrentState, ipaddressresource.FieldStatus, ipaddressresource.FieldStatusDetail, ipaddressresource.FieldConfigMethod:
