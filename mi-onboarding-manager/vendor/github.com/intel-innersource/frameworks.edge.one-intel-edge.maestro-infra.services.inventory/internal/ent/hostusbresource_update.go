...
func (hru *HostusbResourceUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, HostusbResourceMutation](ctx, hru.sqlSave, hru.mutation, hru.hooks)
}
...
func (hruo *HostusbResourceUpdateOne) Save(ctx context.Context) (*HostusbResource, error) {
	return withHooks[*HostusbResource, HostusbResourceMutation](ctx, hruo.sqlSave, hruo.mutation, hruo.hooks)
}
