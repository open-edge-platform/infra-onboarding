...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			ipaddressresource.Table:        ipaddressresource.ValidColumn,
			instanceresource.Table:         instanceresource.ValidColumn,
			...
			projectresource.Table:          projectresource.ValidColumn,
			providerresource.Table:         providerresource.ValidColumn,
			regionresource.Table:           regionresource.ValidColumn,
