...
func (hru *HostgpuResourceUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, HostgpuResourceMutation](ctx, hru.sqlSave, hru.mutation, hru.hooks)
}
...
func (hruo *HostgpuResourceUpdateOne) Save(ctx context.Context) (*HostgpuResource, error) {
	return withHooks[*HostgpuResource, HostgpuResourceMutation](ctx, hruo.sqlSave, hruo.mutation, hruo.hooks)
}
