...
func (ssru *SingleScheduleResourceUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, SingleScheduleResourceMutation](ctx, ssru.sqlSave, ssru.mutation, ssru.hooks)
}
...
func (ssruo *SingleScheduleResourceUpdateOne) Save(ctx context.Context) (*SingleScheduleResource, error) {
	return withHooks[*SingleScheduleResource, SingleScheduleResourceMutation](ctx, ssruo.sqlSave, ssruo.mutation, ssruo.hooks)
}
