...
func (hrc *HostnicResourceCreate) SetSiteID(id int) *HostnicResourceCreate {
...
func (hrc *HostnicResourceCreate) SetNillableSiteID(id *int) *HostnicResourceCreate {
	if id != nil {
...
func (hrc *HostnicResourceCreate) SetSite(s *SiteResource) *HostnicResourceCreate {
	return hrc.SetSiteID(s.ID)
}

// SetProviderID sets the "provider" edge to the ProviderResource entity by ID.
func (hrc *HostnicResourceCreate) SetProviderID(id int) *HostnicResourceCreate {
...
func (hrc *HostnicResourceCreate) SetNillableProviderID(id *int) *HostnicResourceCreate {
	if id != nil {
...
func (hrc *HostnicResourceCreate) SetProvider(p *ProviderResource) *HostnicResourceCreate {
	return hrc.SetProviderID(p.ID)
}

// SetProjectID sets the "project" edge to the ProjectResource entity by ID.
func (hrc *HostnicResourceCreate) SetProjectID(id int) *HostnicResourceCreate {
...
func (hrc *HostnicResourceCreate) SetNillableProjectID(id *int) *HostnicResourceCreate {
	if id != nil {
...
func (hrc *HostnicResourceCreate) SetProject(p *ProjectResource) *HostnicResourceCreate {
...
func (hrc *HostnicResourceCreate) Save(ctx context.Context) (*HostnicResource, error) {
	return withHooks[*HostnicResource, HostnicResourceMutation](ctx, hrc.sqlSave, hrc.mutation, hrc.hooks)
}
...
func (hrc *HostnicResourceCreate) createSpec() (*HostnicResource, *sqlgraph.CreateSpec) {
	...
	if nodes := hrc.mutation.SiteIDs(); len(nodes) > 0 {
		...
		_node.hostnic_resource_site = &nodes[0]
	...
	if nodes := hrc.mutation.ProviderIDs(); len(nodes) > 0 {
		...
		_node.hostnic_resource_provider = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := hrc.mutation.ProjectIDs(); len(nodes) > 0 {
		...
		_node.hostnic_resource_project = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
