...
func ProviderStatus(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldEQ(FieldProviderStatus, v))
}

// ProviderStatusDetail applies equality check predicate on the "provider_status_detail" field. It's identical to ProviderStatusDetailEQ.
func ProviderStatusDetail(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldEQ(FieldProviderStatusDetail, v))
}
...
func ProviderStatusEQ(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldEQ(FieldProviderStatus, v))
}

// ProviderStatusNEQ applies the NEQ predicate on the "provider_status" field.
func ProviderStatusNEQ(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldNEQ(FieldProviderStatus, v))
}

// ProviderStatusIn applies the In predicate on the "provider_status" field.
func ProviderStatusIn(vs ...string) predicate.HostResource {
	return predicate.HostResource(sql.FieldIn(FieldProviderStatus, vs...))
}

// ProviderStatusNotIn applies the NotIn predicate on the "provider_status" field.
func ProviderStatusNotIn(vs ...string) predicate.HostResource {
	return predicate.HostResource(sql.FieldNotIn(FieldProviderStatus, vs...))
}

// ProviderStatusGT applies the GT predicate on the "provider_status" field.
func ProviderStatusGT(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldGT(FieldProviderStatus, v))
}

// ProviderStatusGTE applies the GTE predicate on the "provider_status" field.
func ProviderStatusGTE(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldGTE(FieldProviderStatus, v))
}

// ProviderStatusLT applies the LT predicate on the "provider_status" field.
func ProviderStatusLT(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldLT(FieldProviderStatus, v))
}

// ProviderStatusLTE applies the LTE predicate on the "provider_status" field.
func ProviderStatusLTE(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldLTE(FieldProviderStatus, v))
}

// ProviderStatusContains applies the Contains predicate on the "provider_status" field.
func ProviderStatusContains(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldContains(FieldProviderStatus, v))
}

// ProviderStatusHasPrefix applies the HasPrefix predicate on the "provider_status" field.
func ProviderStatusHasPrefix(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldHasPrefix(FieldProviderStatus, v))
}

// ProviderStatusHasSuffix applies the HasSuffix predicate on the "provider_status" field.
func ProviderStatusHasSuffix(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldHasSuffix(FieldProviderStatus, v))
}

// ProviderStatusIsNil applies the IsNil predicate on the "provider_status" field.
func ProviderStatusIsNil() predicate.HostResource {
	return predicate.HostResource(sql.FieldIsNull(FieldProviderStatus))
}

// ProviderStatusNotNil applies the NotNil predicate on the "provider_status" field.
func ProviderStatusNotNil() predicate.HostResource {
	return predicate.HostResource(sql.FieldNotNull(FieldProviderStatus))
}

// ProviderStatusEqualFold applies the EqualFold predicate on the "provider_status" field.
func ProviderStatusEqualFold(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldEqualFold(FieldProviderStatus, v))
}

// ProviderStatusContainsFold applies the ContainsFold predicate on the "provider_status" field.
func ProviderStatusContainsFold(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldContainsFold(FieldProviderStatus, v))
}

// HostStatusEQ applies the EQ predicate on the "host_status" field.
func HostStatusEQ(v HostStatus) predicate.HostResource {
...
func HostStatusNEQ(v HostStatus) predicate.HostResource {
...
func HostStatusIn(vs ...HostStatus) predicate.HostResource {
...
func HostStatusNotIn(vs ...HostStatus) predicate.HostResource {
...
// ProviderStatusDetailEQ applies the EQ predicate on the "provider_status_detail" field.
func ProviderStatusDetailEQ(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldEQ(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailNEQ applies the NEQ predicate on the "provider_status_detail" field.
func ProviderStatusDetailNEQ(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldNEQ(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailIn applies the In predicate on the "provider_status_detail" field.
func ProviderStatusDetailIn(vs ...string) predicate.HostResource {
	return predicate.HostResource(sql.FieldIn(FieldProviderStatusDetail, vs...))
}

// ProviderStatusDetailNotIn applies the NotIn predicate on the "provider_status_detail" field.
func ProviderStatusDetailNotIn(vs ...string) predicate.HostResource {
	return predicate.HostResource(sql.FieldNotIn(FieldProviderStatusDetail, vs...))
}

// ProviderStatusDetailGT applies the GT predicate on the "provider_status_detail" field.
func ProviderStatusDetailGT(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldGT(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailGTE applies the GTE predicate on the "provider_status_detail" field.
func ProviderStatusDetailGTE(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldGTE(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailLT applies the LT predicate on the "provider_status_detail" field.
func ProviderStatusDetailLT(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldLT(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailLTE applies the LTE predicate on the "provider_status_detail" field.
func ProviderStatusDetailLTE(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldLTE(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailContains applies the Contains predicate on the "provider_status_detail" field.
func ProviderStatusDetailContains(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldContains(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailHasPrefix applies the HasPrefix predicate on the "provider_status_detail" field.
func ProviderStatusDetailHasPrefix(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldHasPrefix(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailHasSuffix applies the HasSuffix predicate on the "provider_status_detail" field.
func ProviderStatusDetailHasSuffix(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldHasSuffix(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailIsNil applies the IsNil predicate on the "provider_status_detail" field.
func ProviderStatusDetailIsNil() predicate.HostResource {
	return predicate.HostResource(sql.FieldIsNull(FieldProviderStatusDetail))
}

// ProviderStatusDetailNotNil applies the NotNil predicate on the "provider_status_detail" field.
func ProviderStatusDetailNotNil() predicate.HostResource {
	return predicate.HostResource(sql.FieldNotNull(FieldProviderStatusDetail))
}

// ProviderStatusDetailEqualFold applies the EqualFold predicate on the "provider_status_detail" field.
func ProviderStatusDetailEqualFold(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldEqualFold(FieldProviderStatusDetail, v))
}

// ProviderStatusDetailContainsFold applies the ContainsFold predicate on the "provider_status_detail" field.
func ProviderStatusDetailContainsFold(v string) predicate.HostResource {
	return predicate.HostResource(sql.FieldContainsFold(FieldProviderStatusDetail, v))
}
...
func HasProject() predicate.HostResource {
	return predicate.HostResource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProjectWith(preds ...predicate.ProjectResource) predicate.HostResource {
	return predicate.HostResource(func(s *sql.Selector) {
		step := newProjectStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasUser() predicate.HostResource {
	return predicate.HostResource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUserWith(preds ...predicate.UserResource) predicate.HostResource {
	return predicate.HostResource(func(s *sql.Selector) {
		step := newUserStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
