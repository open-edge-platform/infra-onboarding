...
require (
	...
	github.com/open-edge-platform/infra-core/inventory/v2 v2.30.11-0.20251029142028-a804096d1305
	github.com/open-edge-platform/infra-onboarding/dkam v1.32.5
