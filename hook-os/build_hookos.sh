...
get_caddy_conf() {
    ...
    $SED_CMD -i "s|update_onboarding_stream_svc|$onboarding_stream_svc|g" hook.yaml
...
build_hook() {
    ...
    if docker image inspect quay.io/tinkerbell/hook-kernel:5.10.85-298651addd526baaf516da71f76997a3e7c8459d >/dev/null 2>&1; then
